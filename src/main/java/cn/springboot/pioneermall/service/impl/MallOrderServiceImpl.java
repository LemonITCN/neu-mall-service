...
import cn.springboot.pioneermall.api.mall.vo.MallOrderListVO;
import cn.springboot.pioneermall.api.mall.vo.MallShoppingCartItemVO;
import cn.springboot.pioneermall.common.*;
import cn.springboot.pioneermall.dao.*;
import cn.springboot.pioneermall.entity.*;
import cn.springboot.pioneermall.service.MallOrderService;
import cn.springboot.pioneermall.util.BeanUtil;
import cn.springboot.pioneermall.util.NumberUtil;
...
public class MallOrderServiceImpl implements MallOrderService {
    ...
    public MallOrderDetailVO getOrderDetailByOrderId(Long orderId) {
        ...
        if (!CollectionUtils.isEmpty(orderItems)) {
            ...
            newBeeMallOrderDetailVO.setMallOrderItemVOS(newBeeMallOrderItemVOS);
